...
class TestControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'test[inter]' => 'Testing',
            'test[datetime]' => 'Testing',
        ]);

        self::assertResponseRedirects('/test/crud/');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'test[inter]' => 'Something New',
            'test[datetime]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getInter());
